...
private:
  ...
  QTableWidgetItem* GetSocketDomain(s32 host_fd) const;
  QTableWidgetItem* GetSocketType(s32 host_fd) const;
  QTableWidgetItem* GetSocketState(s32 host_fd) const;
  QTableWidgetItem* GetSocketName(s32 host_fd) const;
